...
global.devs = "918787651195" // Developer Contact
...
global.read_status_from =  process.env.READ_STATUS_FROM  ||  "918787651195";
...
module.exports = {
  ...
  caption : process.env.CAPTION || "*©²⁰²⁴ Mr.Bot ᴡʜᴀᴛsᴀᴘᴘ ʙᴏᴛs*" , // ```『 ©²⁰²⁴ ɢɪғᴛᴇᴅ ᴡʜᴀᴛsᴀᴘᴘ ʙᴏᴛs 』```", //*『ᴠᴇɴᴏᴄʏʙᴇʀ ᴍᴅ』*\n youtube.com/@giftedtechnexus"),
 
  author : process.env.PACK_AUTHER|| "GiftedTech",
  packname: process.env.PACK_NAME || "WhatsappBots♥️",
  botname : process.env.BOT_NAME  || "Mr Bot-ᴍᴅ",
